    ...
    >
      ...
      >
        ...
        <div className="p-5 sm:p-6 overflow-y-auto custom-scrollbar space-y-4">
          ...
          <div className="bg-gradient-to-r from-amber-500/15 via-amber-400/10 to-transparent border border-amber-500/30 rounded-2xl p-2.5 flex items-center justify-between gap-2 shadow-inner">
            <div className="flex items-center gap-2">
              <span className="text-lg">🎁</span>
              <div>
                <div className="text-xs font-black text-amber-300">500 UGX Welcome Bonus</div>
                <div className="text-[10px] text-slate-300">Credited on entry to stake & play real matches immediately!</div>
              </div>
            </div>
            <span className="px-2 py-0.5 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/40 text-[10px] font-black shrink-0">
              FREE 500 UGX
            </span>
          </div>
