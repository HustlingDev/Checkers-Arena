...
export const CheckersBoard: React.FC<CheckersBoardProps> = ({
  ...
  return (
    <div className="relative flex items-center justify-center select-none w-full h-full p-1 sm:p-2 overflow-hidden touch-none">
      {/* Board Outer Wooden / Theme Frame - Fixed aspect ratio and locked container to prevent table movement */}
      <div
        className="w-full h-full max-w-[min(96vw,calc(100vh-140px),560px)] max-h-[min(96vw,calc(100vh-140px),560px)] aspect-square p-2 sm:p-3 rounded-2xl sm:rounded-3xl border-2 sm:border-4 shadow-2xl flex flex-col justify-between shrink-0 transform-gpu"
        style={{
